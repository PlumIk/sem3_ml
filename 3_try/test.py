...
import numpy as np
from util.util import load_mnist
from cnn.feed import classify
from util.draw_utils import *


def make_classify(test_data, test_target, params):
...
def calc_roc_curve(cls, positive, negative, confidence):
